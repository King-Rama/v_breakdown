"""
Django settings for v_breakdown project.
...
SECRET_KEY = 'fjt=&5g49v#anujh$yc#o4bn^$z25)fvdey7m!q0$mjye=8#v('
...
WSGI_APPLICATION = 'v_breakdown.wsgi.application'
...
JAZZMIN_SETTINGS = {
    # title of the window
    'site_title': 'Vankarim Adminzone',

    # Title on the brand, and the login screen (19 chars max)
    'site_header': 'Vankarim Adminzone',
